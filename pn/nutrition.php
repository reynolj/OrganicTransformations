            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <h3><p>To determine a nutrition plan that will best work for you we need to gather some
                                information about you</p></h3>
                        ...
                        <h3><p>Please select the body type that most resembles yours based on the graphic and
                                description</p></h3>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body" style="text-align:center;">
                                        <div>
                                            <img style='height: 60%; width: 60%; object-fit: contain'
                                                 src="images/ectos.jpg">
                                        </div>
                        ...
                        <div>
                            <h3>
                                <p>Next we have to know your body fat percentage. It is best to go get this tested for a
                                    more precise measure, but you can reference these pictures to get a rough
                                    estimate</p>
                            </h3>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter your body fat % here"
                                       required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <td>
                                <button type="button" class="btn btn-block btn-primary">Calculate my nutrition plan
                                </button>
                            </td>
                        </div>
